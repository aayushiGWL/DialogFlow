...
public class AIServiceSampleActivity extends ai.api.sample.BaseActivity
        implements AIListener, AdapterView.OnItemSelectedListener {

    public static final String TAG = ai.api.sample.AIServiceSampleActivity.class.getName();
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        final ArrayAdapter<ai.api.sample.LanguageConfig> languagesAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, ai.api.sample.Config.languages);
        spinner.setAdapter(languagesAdapter);
        spinner.setOnItemSelectedListener(this);
    }

    private void initService(final ai.api.sample.LanguageConfig selectedLanguage) {
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            startActivity(ai.api.sample.AISettingsActivity.class);
            return true;
        }
    ...
    public void onResult(final AIResponse response) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                ai.api.sample.TTS.speak(speech);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        final ai.api.sample.LanguageConfig selectedLanguage = (ai.api.sample.LanguageConfig) parent.getItemAtPosition(position);
