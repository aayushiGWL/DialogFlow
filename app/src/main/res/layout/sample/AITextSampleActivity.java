 ...
 */
public class AITextSampleActivity extends ai.api.sample.BaseActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {

    public static final String TAG = ai.api.sample.AITextSampleActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter<String> eventAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, ai.api.sample.Config.events);
        ...
        final ArrayAdapter<LanguageConfig> languagesAdapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_dropdown_item, ai.api.sample.Config.languages);
