...
public class AIApplication extends Application {
    ...
    private static final String TAG = ai.api.sample.AIApplication.class.getSimpleName();

    private int activitiesCount;
    private BluetoothControllerImpl bluetoothController;
    private ai.api.sample.SettingsManager settingsManager;

    @Override
    public void onCreate() {
        super.onCreate();
        bluetoothController = new BluetoothControllerImpl(this);
        settingsManager = new ai.api.sample.SettingsManager(this);
    }
    ...
    public ai.api.sample.SettingsManager getSettingsManager() {
