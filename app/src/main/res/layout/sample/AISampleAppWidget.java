...
public class AISampleAppWidget extends AppWidgetProvider {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        if (intent.getAction().equals(ACTION_KEY)) {
            ...
            final Intent popUpIntent = new Intent(context, ai.api.sample.AIWidgetActivity.class);
    ...
    static void updateAppWidget(final Context context, final AppWidgetManager appWidgetManager,
        ...
        final Intent intent = new Intent(context, ai.api.sample.AISampleAppWidget.class);
