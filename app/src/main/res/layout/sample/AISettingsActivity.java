...
public class AISettingsActivity extends ai.api.sample.BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingsManager = ((ai.api.sample.AIApplication) getApplication()).getSettingsManager();
